    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                'bold', 'italic', 'underline', 'fontborder', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch', 'autotypeset', 'blockquote', 'pasteplain','wordpaster','excelpaster', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist', 'selectall', 'cleardoc', '|',
        ...
        ,labelMap:{
            'wordpaster':'粘贴图片或自动上传Word中的图片', 'excelpaster':'粘贴Excel并自动上传图片'
        }
        //webAppKey
